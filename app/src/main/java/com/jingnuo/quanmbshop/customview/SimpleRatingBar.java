...
public class SimpleRatingBar extends View {
  ...
  public enum Gravity {
    ...
    Left(0),
    /**
     * Right gravity: the bl be filled starting from right to left.
     */
    Right(1);
  ...
  private void parseAttrs(AttributeSet attrs) {
    ...
    borderColor = arr.getColor(R.styleable.SimpleRatingBar_srb_borderColor, getResources().getColor(R.color.yellow_jianbian_start));
    ...
    rating = normalizeRating(R.styleable.SimpleRatingBar_srb_rating);
