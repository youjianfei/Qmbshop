...
public class LoveTaskDetailsActivity extends BaseActivityother {
    ...
    protected void setData() {
        ...
        popwindow_jubao1=new Popwindow_jubao1(LoveTaskDetailsActivity.this, new Interence_jubao() {
            @Override
...
//                    Utils.setAlpha((float) 1,ErshouxinxiDetailsActivity.this);
        ...
        popwindow_jubao2=new Popwindow_jubao2(this, new Interence_jubao() {
            ...
            public void onResult(String result) {
                switch (result){
                    case "tousu":
                        Intent intent=new Intent(LoveTaskDetailsActivity.this,JubaoActivity.class);
                        intent.putExtra("jubaoid",loveTaskDetailsBean.getData().getTask_id()+"");
                        intent.putExtra("typeID","2");
                        LoveTaskDetailsActivity.this.startActivity(intent);
                        break;
                    case "xujia":
                        jubao("虚假信息");
                        break;
    ...
    void  jubao(String jubaoneirong){
        ...
        new Volley_Utils(new Interface_volley_respose() {
            ...
            public void onSuccesses(String respose) {
                ...
                if(status==1){
                    ToastUtils.showToast(LoveTaskDetailsActivity.this,msg);
                }else {
                    ToastUtils.showToast(LoveTaskDetailsActivity.this,msg);
                }
        ...
        }).postHttp(Urls.Baseurl+Urls.myJubao,LoveTaskDetailsActivity.this,1,map);
