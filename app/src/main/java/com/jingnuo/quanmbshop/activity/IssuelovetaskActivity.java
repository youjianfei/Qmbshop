...
public class IssuelovetaskActivity extends BaseActivityother {
    //控件
    ...
    Map map_issueLoveTask;

    @Override
    public int setLayoutResID() {
        return R.layout.activity_issuelovetask;
    }
...
//                    progressDlog.cancelPD();
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastUtils.showToast(IssuelovetaskActivity.this,"网络开小差儿，请重新提交");
                        }
                    });
                    mList_picID.clear();
                    return;
                ...
                try {
                    ...
                    if(status==1){
                        ...
                        if(count!=mList_PicPath_down.size()){
                            ...
                            map_issueLoveTask.put("task_Img_id",img_id);
...
//                        progressDlog.cancelPD();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                ToastUtils.showToast(IssuelovetaskActivity.this, finalMsg);
                            }
                        });
    ...
    protected void initData() {
        permissionHelper = new PermissionHelper(IssuelovetaskActivity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, 100);
        mKProgressHUD = new KProgressHUD(IssuelovetaskActivity.this);
        mPiclist=new ArrayList<>();
        mList_picID=new ArrayList<>();
        map_issueLoveTask=new HashMap();
...
//                    progressDlog.showPD("正在发布，请稍等");
    ...
    boolean checknull(){
        ...
        if(description.equals("")){
            ToastUtils.showToast(this,"请详细描述任务");
            return false;
        }
        ...
        map_issueLoveTask.put("task_description",description);
        map_issueLoveTask.put("x_value",Staticdata.xValue);
        map_issueLoveTask.put("y_value",Staticdata.yValue);
        map_issueLoveTask.put("city_code",Staticdata. city_location);
    ...
    void request (Map map){
        String URL="";
            URL=  Urls.Baseurl_cui+Urls.IssueLovetask;
...
//                    progressDlog.cancelPD();
                    mKProgressHUD.dismiss();
                    ToastUtils.showToast(IssuelovetaskActivity.this,msg);
                    finish();
                }else {
...
//                            .filePath("/ImageSelector/Pictures")
                            .build();
                    ImageSelector.open(IssuelovetaskActivity.this, imageConfig);   // 开启图片选择器
                } else {
                    ToastUtils.showToast(IssuelovetaskActivity.this, "请允许开启照相功能，并读取本地文件");
                }
            }
        });
